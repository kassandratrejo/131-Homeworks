...
library(tidyverse)
library(tidymodels)
codebook<-read_csv("data/abalone_codebook.txt",show_col_types = FALSE)
```
...
Used rings to generate age. function of age. 
```{r}
...
abalone_metrics(abalone_train_res, truth = age, 
                estimate = .pred)
```
The R2 value is 0.558. This means that 0.558 of the variability in Y can be explained using X. 
